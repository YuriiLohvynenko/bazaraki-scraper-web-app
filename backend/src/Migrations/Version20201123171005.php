 ...
 */
final class Version20201123171005 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE staff_login_history (id INT AUTO_INCREMENT NOT NULL, staff_id_id INT NOT NULL, logged_in_at DATETIME DEFAULT NULL, ip VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_747B135E2A13690 (staff_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE staff_login_history ADD CONSTRAINT FK_747B135E2A13690 FOREIGN KEY (staff_id_id) REFERENCES staff (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE staff_login_history');
