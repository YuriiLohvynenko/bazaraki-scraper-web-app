 ...
 */
final class Version20200421102054 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE change_log (id INT AUTO_INCREMENT NOT NULL, listing_id INT NOT NULL, created_at DATETIME NOT NULL, changed_by VARCHAR(255) NOT NULL, changes LONGBLOB NOT NULL, INDEX IDX_5E1A0AD8D4619D1A (listing_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE change_log ADD CONSTRAINT FK_5E1A0AD8D4619D1A FOREIGN KEY (listing_id) REFERENCES listing (id)');
        $this->addSql('ALTER TABLE listing CHANGE zip_code zip_code INT DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT NULL, CHANGE area area VARCHAR(255) DEFAULT NULL, CHANGE lat lat VARCHAR(255) DEFAULT NULL, CHANGE lon lon VARCHAR(255) DEFAULT NULL, CHANGE assigned_to assigned_to VARCHAR(255) DEFAULT NULL, CHANGE duplicate_external_id duplicate_external_id INT DEFAULT NULL, CHANGE listing_type listing_type VARCHAR(255) NOT NULL, CHANGE area_size area_size INT DEFAULT NULL, CHANGE property_condition property_condition VARCHAR(255) DEFAULT NULL, CHANGE commercial_property_type commercial_property_type VARCHAR(255) DEFAULT NULL');
    }
